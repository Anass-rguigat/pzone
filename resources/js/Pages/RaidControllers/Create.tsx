    ...
    return (
        <Layout>
            <div className="px-4 py-6 sm:px-6">
                <h1 className="text-2xl font-semibold mb-6">Ajouter un Nouveau Contrôleur RAID</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            <label htmlFor="supported_levels" className="block text-sm font-medium text-gray-700">Niveaux supportés</label>
                            <input
                                type="text"
                                ...
                                className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            />
                            {errors.supported_levels && <p className="text-red-600 text-sm">{errors.supported_levels}</p>}
                        </div>
                    </div>
