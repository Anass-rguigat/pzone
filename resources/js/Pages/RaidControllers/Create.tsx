...
export default function Create({ brands, servers }: Props) {
    ...
    return (
        ...
        >
            <h1>Ajouter un contrôleur RAID</h1>
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                <div>
                    <label htmlFor="name">Nom du contrôleur RAID:</label>
                    <input
                        type="text"
                        name="name"
                        value={data.name}
                ...
                <div className="mt-4">
                    <label htmlFor="supported_levels">Niveaux supportés:</label>
                    <input
                        type="text"
                        ...
                        className="mt-1 p-2 border rounded"
                    />
                    {errors.supported_levels && <div className="text-red-600 text-sm">{errors.supported_levels}</div>}
                </div>
                ...
                <div className="mt-4">
                    ...
                    >
                        {processing ? 'Enregistrement...' : 'Ajouter le contrôleur RAID'}
                    </button>
                </div>
            </form>
        </AuthenticatedLayout>
