...
export default function Edit({ coolingSolution, brands, servers }: Props) {
    ...
    return (
        ...
        >
            <h1 className="text-2xl font-bold mb-4">Modifier une solution de refroidissement</h1>

            <form onSubmit={handleSubmit} className="space-y-4">
                {/* Cooling Solution Name */}
                <div>
                    <label className="block font-medium">Nom de la solution de refroidissement</label>
                    <input
                        type="text"
                        value={data.name}
                ...
                {/* Manufacturer */}
                <div>
                    <label className="block font-medium">Fabricant</label>
                    <input
                        type="text"
                ...
                {/* Power Rating */}
                <div>
                    <label className="block font-medium">Consommation électrique (W)</label>
                    <input
                        type="number"
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="/cooling-solutions" className="bg-gray-500 text-white px-4 py-2 rounded">
                        Retour à la liste
                    </Link>
                </div>
            </form>
