    ...
    return (
        ...
        >
            <div className="px-4 py-6 sm:px-6">
                <h1 className="text-2xl font-semibold mb-6">Ajouter un Nouveau Connecteur de Câble</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label htmlFor="length" className="block text-sm font-medium text-gray-700">Longueur (en mètres)</label>
                            <input
                                type="number"
                                name="length"
                                id="length"
