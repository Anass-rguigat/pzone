...
export default function Edit({ battery, brands, servers }: Props) {
    ...
    useEffect(() => {
        if (battery.image) {
            setSelectedImage(`/storage/${battery.image.url}`);
        }
    }, [battery]);
    ...
    return (
        ...
        >
            <div className="px-4 py-6 sm:px-6">
                <h1 className="text-2xl font-semibold mb-6">Modifier une Batterie</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-4 ">
                        ...
                        <Link href="/batteries" className="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">
                            Retour à la liste
                        </Link>
                    </div>
                </form>
