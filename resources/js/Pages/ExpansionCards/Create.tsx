...
export default function Create({ brands, servers }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        interface_type: '', // Ajout du type d'interface
        speed: '', // Ajout de la vitesse
    ...
    return (
        ...
        >
            <h1>Ajouter une Carte d'Extension</h1>
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                <div>
                    <label htmlFor="name">Nom de la carte d'extension:</label>
                    <input
                        type="text"
                        name="name"
                        value={data.name}
                ...
                <div className="mt-4">
                    <label htmlFor="interface_type">Type d'interface:</label>
                    <input
                        type="text"
                        name="interface_type"
                        ...
                        className="mt-1 p-2 border rounded"
                    />
                    {errors.interface_type && <div className="text-red-600 text-sm">{errors.interface_type}</div>}
                </div>
                ...
                <div className="mt-4">
                    <label htmlFor="power_rating">Puissance:</label>
                    <input
                        type="number"
                        name="power_rating"
